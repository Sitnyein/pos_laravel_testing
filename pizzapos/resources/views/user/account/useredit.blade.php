                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ route('client#page') }}" class="nav-item nav-link active">Home  <i class="fa-solid fa-house-user"></i>
                                <i class="fa-solid fa-house-user"></i>  <i class="fa-solid fa-house-user"></i>
                            </a>
        ...
        <div class="card">
            <div class="card-body">
                <div class="card-title">
                    <h3 class="text-center title-2">User acc edit</h3>
                </div>
                <div class="my-2">
                    <a href="{{ route('user#detail') }}" class="text-decoration-none text-black"> <i
                ...
                <form action="{{route('user#update',Auth::user()->id)}}" method="POST"
                    ...
                    <div class="row">
                        <div class="col-4 offset-1 mt-4">
                           ...
                           @else
                           <img src="{{asset('image/girl.png')}}" class="  shadow-sm" style="height:300px;width:300px;">
                           @endif
                            @else
                                <img src="{{ asset('storage/' . Auth::user()->image) }}" class="  shadow-sm" style="height:320px;width:320px;" />
                            @endif
                            <div class=" mt-3">
                                <input type="file" name="image"
                                    class="form-control @error('image') is-invalid    @enderror"  aria-required="true" aria-invalid="false">
                                    @error('image')
